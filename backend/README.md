...
## Project Structure
    ...
    ├── ideapros_cancerscre_32423  # Django project configurations
...
1. Clone this repo and `cd ideapros_cancerscre_32423`
...
2. Clone this repo and `cd ideapros_cancerscre_32423`
